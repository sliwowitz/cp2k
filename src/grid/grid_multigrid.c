...
void grid_create_fft_grid(grid_fft_grid **fft_grid, const grid_mpi_comm comm,
  ...
  for (int proc = 0; proc < number_of_processes; proc++) {
    ...
    my_fft_grid->proc2local_rs[proc][2][0] = 1;
    my_fft_grid->proc2local_rs[proc][2][1] = npts_global[2];
    ...
    my_fft_grid->proc2local_ms[proc][0][1] =
        (proc_coords[0] + 1) * npts_global[0] / my_fft_grid->proc_grid[0] - 1;
    my_fft_grid->proc2local_ms[proc][1][0] = 1;
    my_fft_grid->proc2local_ms[proc][1][1] = npts_global[1];
    ...
    my_fft_grid->proc2local_gs[proc][0][0] = 1;
    my_fft_grid->proc2local_gs[proc][0][1] = npts_global[0];
