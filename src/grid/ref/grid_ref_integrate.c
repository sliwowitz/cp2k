...
void grid_ref_integrate_pgf_product(
    const grid_ref_layout *layout, const bool compute_tau,
  ...
  cab_to_grid(layout, border_mask, la_max_local, la_min_local, lb_max_local,
              lb_min_local, zeta, zetb, rscale, ra, rab, radius, cab, grid);
